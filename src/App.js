    ...
    return (
        <Col style={{margin: '20px 0'}} className="gutter-row" span={4}>
            <div className="gutter-box">
                <Card
                    style={{ width: '200px', height:'380px', border:'1px solid #dcdde1', cursor:'pointer' ,borderRadius: "5px" }}
                    cover={
                        <img
                            alt={Title}
                            src={Poster === 'N/A' ? 'https://placehold.it/198x264&text=Image+Not+Found' : Poster}
                            style={{height:'280px' ,padding:'3px',borderRadius: "5px"}}
                        />
                    }
    ...
    return (
        <div className="App">
            <Layout className="layout">
                ...
                <Footer style={{ textAlign: 'center' }}>OMDB API Movies ©2022</Footer>
            </Layout>
        </div>
    );
}
